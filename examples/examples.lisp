...
(document :file
 (description "This file demonstrates examples of use of the 'de.setf.amqp' library.")
 (copyright
 ...
 (long-description "These have been sporadically tests with
...
(defparameter *c*
  (make-instance 'amqp:connection :uri "amqp://guest:guest@192.168.1.25/"))

#+(or )
(defparameter *c*
  (make-instance 'amqp:connection :uri "amqp://guest:guest@yoda.setf.de/"))
