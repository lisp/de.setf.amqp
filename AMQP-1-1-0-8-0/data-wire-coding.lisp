...
(def-encodings (:amqp-1-1-0-8-0)
  ...
  (field-table        amqp:table           :line-code #\F  :codec amqp-1-1-0-8-0::buffer-table)
  ...
  (no-wait            amqp:bit)
  (path               (amqp:string 8))
  (peer-properties    amqp:table           :codec amqp-1-1-0-8-0::buffer-table)
  ...
  (table              amqp:table           :codec amqp-1-1-0-8-0::buffer-table)
  )
